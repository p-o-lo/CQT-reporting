...
def bell_circuit(basis, wire_names):
...
def set_parametrized_circuits(wire_names: list) -> list[Circuit]:
    ...
    basis = ["00", "01", "10", "11"]
    for base in basis:
        chsh_circuits.append(bell_circuit(base, wire_names))
